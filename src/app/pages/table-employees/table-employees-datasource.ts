...
export class TableEmployeesDataSource extends DataSource<TableEmployeesItem> {
   ...
   */
  connect(): Observable<TableEmployeesItem[]> {
   ...
   */
  private getPagedData(data: TableEmployeesItem[]): TableEmployeesItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TableEmployeesItem[]): TableEmployeesItem[] {

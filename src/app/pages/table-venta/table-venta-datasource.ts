...
export interface TableVentaItem {
    id:number;
    fecha:string;
    cliente:string;
    producto:string;
 ...
 */
export class TableVentaDataSource extends DataSource<TableVentaItem> {
  data: TableVentaItem[] = [];
   ...
   */
  connect(): Observable<TableVentaItem[]> {
   ...
   */
  private getPagedData(data: TableVentaItem[]): TableVentaItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TableVentaItem[]): TableVentaItem[] {
